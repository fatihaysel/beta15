...
',
    ...
    'clarkwinkelmann-popular-discussion-badge.forum.badge_label' => 'Popular',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.mode' => 'Mode of operation',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.mode_help' => 'Frontend mode is an efficient solution that doesn\'t use the database. Scheduler mode requires a CRON setup and allows timeframes in the conditions.
',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.mode_options.frontend' => 'Frontend',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.mode_options.scheduler' => 'Scheduler (CRON)',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.scheduler_frequency' => 'Frequency for the scheduled mode',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.scheduler_frequency_help' => 'How often the popular status will be updated in Scheduler (CRON) mode. (In Frontend mode, the status is always immediately updated)
',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.scheduler_frequency_options.everyFiveMinutes' => 'Every 5 minutes',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.scheduler_frequency_options.everyTenMinutes' => 'Every 10 minutes',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.scheduler_frequency_options.everyFifteenMinutes' => 'Every 15 minutes',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.scheduler_frequency_options.everyThirtyMinutes' => 'Every 30 minutes',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.scheduler_frequency_options.hourly' => 'Once per hour',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.conditions' => 'Conditions for popular badge',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.conditions_help' => 'Comments is the total number of comment posts including the first post. Views are retrieved from either MichaelBelgium or Flarumite extensions. The timeframe given will be used to count the comments or views within the last n hours. Only MichaelBelgium extension is supported for timeframed views. Leave timeframe empty or set 0 hours to count all comments or views ever.
',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.add' => 'Add another condition',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.comments' => 'Comments',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.comments_placeholder' => '0',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.views' => 'Views',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.views_placeholder' => '0',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.within' => 'within',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.within_placeholder' => 'all',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.hours' => 'h',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.and' => 'AND',
    'clarkwinkelmann-popular-discussion-badge.admin.settings.or' => 'OR',
    'ianm-synopsis.admin.settings.excerpt-label' => 'Summary excerpt length in characters',
    'ianm-synopsis.admin.settings.rich-excerpts' => 'Display excerpts using rich content (use with caution)',
    'ianm-synopsis.admin.settings.excerpt-type' => 'Which post should be displayed as the excerpt?',
    ...
    'fof-webhooks.actions.discussion.started' => 'Started discussion `{1}`',
    'fof-webhooks.actions.discussion.renamed.title' => 'Renamed discussion `{1}`',
    'fof-webhooks.actions.discussion.renamed.description' => 'New title: {1}',
    'fof-webhooks.actions.discussion.hidden' => 'Hid discussion `{1}`',
    'fof-webhooks.actions.discussion.restored' => 'Restored discussion `{1}`',
    'fof-webhooks.actions.discussion.deleted' => 'Deleted discussion `{1}`',
    'fof-webhooks.actions.group.created' => 'Created `{1}` group',
    'fof-webhooks.actions.group.renamed' => 'Renamed a group to `{1}`',
    'fof-webhooks.actions.group.deleted' => 'Deleted `{1}` group',
    'fof-webhooks.actions.post.posted' => 'New post in `{1}`',
    'fof-webhooks.actions.post.revised' => 'Edited post in `{1}`',
    'fof-webhooks.actions.post.hidden' => 'Hid post in `{1}`',
    'fof-webhooks.actions.post.restored' => 'Restored post in `{1}`',
    'fof-webhooks.actions.post.deleted' => 'Deleted post in `{1}`',
    'fof-webhooks.actions.user.registered' => 'New user registered',
    'fof-webhooks.actions.user.renamed.title' => 'Changed username of `{1}`',
    'fof-webhooks.actions.user.renamed.description' => 'New username: {1}',
    'fof-webhooks.actions.user.deleted' => 'Deleted user `{1}`',
    'fof-webhooks.adapters.errors.404' => 'Webhook Not Found',
    'fof-webhooks.admin.errors.service_not_found' => 'The service \'{service}\' cannot be found.',
    'fof-webhooks.admin.errors.url_invalid' => 'URL is not valid for selected service.',
    'fof-webhooks.admin.nav.desc' => 'Customizable outgoing webhooks for your forum.',
    'fof-webhooks.admin.settings.item.tag_any_label' => 'Any',
    'fof-webhooks.admin.settings.help.disabled' => 'This webhook is disabled because it doesn\'t have any events enabled.',
    'fof-webhooks.admin.settings.help.general' => 'Here you can add, edit, and remove webhooks from your forum.',
    'fof-webhooks.admin.settings.help.url' => 'The webhook\'s endpoint to be executed',
    'fof-webhooks.admin.settings.modal.title' => 'Webhook Settings',
    'fof-webhooks.admin.settings.modal.description' => 'Here you modify what events the webhook is fired on.',
    'fof-webhooks.admin.settings.modal.extra_text_label' => 'Extra Text',
    'fof-webhooks.admin.settings.modal.extra_text_help' => 'Extra text to include in the sent webhook.',
    'fof-webhooks.admin.settings.modal.group_label' => 'Group',
    'fof-webhooks.admin.settings.modal.group_help' => 'Send resources that can be seen by this group',
    'fof-webhooks.admin.settings.modal.events_label' => 'Events',
    'fof-webhooks.admin.settings.services.discord' => 'Discord',
    'fof-webhooks.admin.settings.services.slack' => 'Slack',
    'fof-webhooks.admin.settings.services.microsoft-teams' => 'Microsoft Teams',
    'fof-webhooks.admin.settings.actions.flarum.discussion.title' => 'Flarum Discussion',
    'fof-webhooks.admin.settings.actions.flarum.discussion.started' => 'Started',
    'fof-webhooks.admin.settings.actions.flarum.discussion.renamed' => '=> fof-webhooks.ref.renamed',
    'fof-webhooks.admin.settings.actions.flarum.discussion.hidden' => '=> fof-webhooks.ref.hidden',
    'fof-webhooks.admin.settings.actions.flarum.discussion.restored' => '=> fof-webhooks.ref.restored',
    'fof-webhooks.admin.settings.actions.flarum.discussion.deleted' => '=> fof-webhooks.ref.deleted',
    'fof-webhooks.admin.settings.actions.flarum.group.title' => 'Flarum Group',
    'fof-webhooks.admin.settings.actions.flarum.group.created' => 'Created',
    'fof-webhooks.admin.settings.actions.flarum.group.renamed' => '=> fof-webhooks.ref.renamed',
    'fof-webhooks.admin.settings.actions.flarum.group.deleted' => '=> fof-webhooks.ref.deleted',
    'fof-webhooks.admin.settings.actions.flarum.post.title' => 'Flarum Post',
    'fof-webhooks.admin.settings.actions.flarum.post.posted' => 'Posted',
    'fof-webhooks.admin.settings.actions.flarum.post.revised' => 'Edited',
    'fof-webhooks.admin.settings.actions.flarum.post.hidden' => '=> fof-webhooks.ref.hidden',
    'fof-webhooks.admin.settings.actions.flarum.post.restored' => '=> fof-webhooks.ref.restored',
    'fof-webhooks.admin.settings.actions.flarum.post.deleted' => '=> fof-webhooks.ref.deleted',
    'fof-webhooks.admin.settings.actions.flarum.user.title' => 'Flarum User',
    'fof-webhooks.admin.settings.actions.flarum.user.registered' => 'Registered',
    'fof-webhooks.admin.settings.actions.flarum.user.renamed' => '=> fof-webhooks.ref.renamed',
    'fof-webhooks.admin.settings.actions.flarum.user.deleted' => '=> fof-webhooks.ref.deleted',
    'fof-webhooks.ref.deleted' => 'Deleted',
    'fof-webhooks.ref.hidden' => 'Hidden',
    'fof-webhooks.ref.renamed' => 'Renamed',
    'fof-webhooks.ref.restored' => 'Restored',
    'askvortsov-help-tags.admin.permissions.view_tag_label' => 'View Tag',
    ...
    'fof-best-answer.admin.settings.label.reminders_notice' => 'For reminders to function correctly, you must have set up the Flarum scheduler correctly.',
...
Thanks!
',
    'the-turk-fancybox.forum.next' => 'Next',
    'the-turk-fancybox.forum.prev' => 'Previous',
    'the-turk-fancybox.forum.close' => 'Close',
    'the-turk-fancybox.forum.error' => 'The requested content cannot be loaded.',
...
Thank you for your understanding.',
    ...
    'fof-ignore-users.forum.badge.user_label' => 'Ignored user',
    'fof-ignore-users.forum.badge.discussion_label' => 'Started by an ignored user',
...
',
    ...
    'tiborsulyan-autologout.admin.settings.logoutAfter' => 'Inactivity period to log out users (in minutes)',
    'tiborsulyan-autologout.admin.settings.warnAfter' => 'Inactivity period for the warning message to appear (in minutes)',
    'tiborsulyan-autologout.admin.validation.logoutTimeoutNotSet' => 'Logout timeout should be also set if warn timeout is set',
    'tiborsulyan-autologout.admin.validation.logoutTimeoutTooBig' => 'Logout timeout cannot be greater than the session lifetime (sessionLifetime minutes)',
    'tiborsulyan-autologout.admin.validation.warnTimeoutTooBig' => 'Warning timeout should be smaller than logout timeout',
    'tiborsulyan-autologout.forum.warning-modal.title' => 'Your session is about to expire',
    'tiborsulyan-autologout.forum.warning-modal.remaining' => 'Remaining time:',
    'tiborsulyan-autologout.forum.warning-modal.stay' => 'Stay logged in',
    'tiborsulyan-autologout.forum.warning-modal.leave' => 'Logout',
  ),
));
